...
class KeyCell: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        digitsLabel.text = "8"
        digitsLabel.font = UIDevice.current.screenType == .iPhones_5_5s_5c_SE ? .boldSystemFont(ofSize: 24) : UIFont.systemFont(ofSize: 32)
        digitsLabel.textAlignment = .center
        lettersLabel.text = "A B C"
        lettersLabel.font = UIDevice.current.screenType == .iPhones_5_5s_5c_SE ? .boldSystemFont(ofSize: 8) : UIFont.boldSystemFont(ofSize: 10)
